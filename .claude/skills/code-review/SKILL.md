---
name: code-review
description: General code review for bugs, security vulnerabilities, performance issues, and style violations. For frontend-specific reviews (React, JSX, JavaScript), use code-review-frontend instead. For backend-specific reviews (Spring Boot, Java), use code-review-backend instead. Use this skill for general or mixed-stack reviews, infrastructure code, or when the stack is unclear.
---

# Code Review Skill (General)

For stack-specific reviews, use the dedicated skills:
- **Frontend** (React, JavaScript, JSX, Redux, Axios): use `code-review-frontend`
- **Backend** (Spring Boot, Java, JPA, Flyway): use `code-review-backend`
